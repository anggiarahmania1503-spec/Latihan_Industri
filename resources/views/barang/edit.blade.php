                ...
                <div class="card-body">
                   <form action="{{ route('barang.update', $barang->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                        ...
                        <div class="mb-3">
                            <label>Merek</label>
                            <input type="text" class="form-control" name="merek" placeholder="merek"  value="{{ $barang->merek }}">
                             @error('merek')
                            <small style= "color:red">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label>Stok</label>
                            <input type="text" class="form-control" name="stok" placeholder="Stok"  value="{{ $barang->stok }}">
                             @error('stok')
                            <small style= "color:red">{{ $message }}</small>
                            @enderror
                        </div>
